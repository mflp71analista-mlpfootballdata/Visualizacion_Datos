...
Colección de scripts y desarrollos en **Python** enfocados en la representación gráfica, el diseño visual de perfiles individuales y la generación de informes comparativos para scouting técnico.
...
* **Lenguaje:** Python
* **Librerías de Visualización:** PyPizza (mplsoccer), Matplotlib, Seaborn
* **Procesamiento de Datos:** Pandas, NumPy
* **Fuentes de Datos:** Wyscout, FBref

---

## 📊 Tipologías de Visualización Incluidas

### 1. Gráficos de Radar & Perfiles Pizza (`PyPizza`)
